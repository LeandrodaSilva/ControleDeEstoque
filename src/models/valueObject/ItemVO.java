...
public class ItemVO implements Serializable{
     ...
     */
    public ItemVO(int itemCode, int itemQuantity, String itemName, double itemPrice) {
     ...
     * @param itemPrice - Double contendo o preço do item
     */
    public ItemVO(int itemCode, int itemQuantity, String itemName, String itemDescription, double itemPrice) {
        this.itemName = itemName;
        this.itemCode = itemCode;
        this.itemQuantity = itemQuantity;
        this.itemPrice = itemPrice;
